...
MODEL_FILE = (
    MAINTENANCE_MODEL_DIR
    / "maintenance_temporal_classifier.joblib"
)

RESULTS_FILE = (
    MAINTENANCE_MODEL_DIR
    / "maintenance_temporal_model_results.csv"
)

METADATA_FILE = (
    MAINTENANCE_MODEL_DIR
    / "maintenance_temporal_model_metadata.json"
)

CONFUSION_MATRIX_FILE = (
    FIGURES_DIR
    / "maintenance_temporal_confusion_matrix.png"
)
...
def load_data():
    ...
    print("\n" + "=" * 70)
    print("LOADING TEMPORAL MAINTENANCE FEATURES")
    print("=" * 70)
...
def create_preprocessor(
    ...
    # --------------------------------------------------------
    # There are currently no categorical features in the
    # temporal dataset. We still keep this branch so the
    # training pipeline remains reusable.
    # --------------------------------------------------------
...
def create_models():
    ...
    print("\n" + "=" * 70)
    print("CREATING TEMPORAL CLASSIFICATION MODELS")
    print("=" * 70)
...
def select_best_model(
    ...
    print("\n" + "=" * 70)
    print("SELECTING BEST TEMPORAL MODEL")
    print("=" * 70)
...
def save_model(
    ...
    print("\n" + "=" * 70)
    print("SAVING TEMPORAL MAINTENANCE MODEL")
    print("=" * 70)
...
def save_model_results(
    ...
    print("\n" + "=" * 70)
    print("SAVING TEMPORAL MODEL RESULTS")
    print("=" * 70)
...
def save_metadata(
    ...
    print("\n" + "=" * 70)
    print("SAVING TEMPORAL MODEL METADATA")
    print("=" * 70)
...
def main():
    ...
    print("\n" + "=" * 70)
    print("SMARTLOGIX AI")
    print("TEMPORAL PREDICTIVE MAINTENANCE")
