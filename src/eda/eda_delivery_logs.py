...
def bivariate_analysis(df):
    ...
    identifier_columns = [
        ...
        or column.lower() == "log_id"
        or column.lower() == "order_id"
    ]
    ...
    print(
        "\nCategorical columns used for analysis:"
    )
    ...
    if (
        ...
        category = analysis_categorical_columns[0]
...
def visualizations(df):
    ...
    if len(numerical_columns) >= 1:
        ...
        plt.savefig(
            FIGURES_DIR /
            "delivery_logs_numeric_distribution.png",
            dpi=300
        )
    ...
    if len(numerical_columns) >= 1:
        ...
        plt.savefig(
            FIGURES_DIR /
            "delivery_logs_numeric_boxplot.png",
            dpi=300
        )
    ...
    if len(categorical_columns) >= 1:
        ...
        plt.savefig(
            FIGURES_DIR /
            "delivery_logs_categorical_distribution.png",
            dpi=300,
            bbox_inches="tight"
        )
    ...
    if len(numerical_columns) >= 2:
        ...
        plt.savefig(
            FIGURES_DIR /
            "delivery_logs_numeric_relationship.png",
            dpi=300
        )
    ...
    if len(categorical_columns) >= 2:
        ...
        plt.savefig(
            FIGURES_DIR /
            "delivery_logs_categorical_relationship.png",
            dpi=300,
            bbox_inches="tight"
        )
