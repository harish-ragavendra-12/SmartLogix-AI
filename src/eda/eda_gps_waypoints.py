...
def univariate_analysis(df):
    ...
    for column in categorical_columns:
        ...
        # Skip high-cardinality identifier columns
        if (
...
def visualizations(df):
    ...
    if len(numerical_columns) >= 1:
        ...
        plt.savefig(
            FIGURES_DIR /
            "gps_waypoints_numeric_distribution.png",
            dpi=300
        )
    ...
    if len(numerical_columns) >= 1:
        ...
        plt.savefig(
            FIGURES_DIR /
            "gps_waypoints_numeric_boxplot.png",
            dpi=300
        )
    ...
    if len(categorical_columns) >= 1:
        ...
        plt.savefig(
            FIGURES_DIR /
            "gps_waypoints_categorical_distribution.png",
            dpi=300,
            bbox_inches="tight"
        )
    ...
    if len(numerical_columns) >= 2:
        ...
        plt.savefig(
            FIGURES_DIR /
            "gps_waypoints_numeric_relationship.png",
            dpi=300
        )
    ...
    if len(categorical_columns) >= 2:
        ...
        plt.savefig(
            FIGURES_DIR /
            "gps_waypoints_categorical_relationship.png",
            dpi=300,
            bbox_inches="tight"
        )
